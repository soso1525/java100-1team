...
<c:forEach items="${list}" var="msg2">
    <tr>
        ...
        <td>${msg2.mcont}</td>
       <%--  <td>${msg.mcheck}</td> --%>
        <c:if test="${msg2.mcheck!=0}"><td><a href='${msg2.mno}'>읽은쪽지</a></td></c:if>
        <c:if test="${msg2.mcheck==0}"><td><a href='${msg2.mno}'>안읽은쪽지</a></td></c:if>
    </tr>
</c:forEach>

<a href="receiveList">받은쪽지함</a>
</tbody>
</table>
