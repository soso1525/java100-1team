...
<body>
	<div class='container'>
		...
		<form action='iAdd' method='post'>
			...
			<div class='form-group row'>
				...
				<div class='col-sm-10'>
					<input class='form-control' id='checkpassword' readonly type='text'
						name='checkpassword'>
				</div>
			</div>
			...
			<div class="form-group row">
				<label for='tel' class='col-sm-2 col-form-label'>지역</label>
				<div class='col-sm-10'>
			...
			<div class='form-group row'>
				<div class='col-sm-10'>
					<button class='btn btn-primary btn-sm' id="btn-enrol"
	...
	<script charset="UTF-8" type="text/javascript"
		src="http://t1.daumcdn.net/cssjs/postcode/1513129253770/171213.js"></script>
	<script>
